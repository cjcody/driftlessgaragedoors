            ...
            <div className="space-y-2 text-gray-400">
              ...
              <div className="pt-2">
                <a 
                  ...
                  className="inline-block text-gray-400 hover:text-red-500 transition-colors duration-200 mr-4"
                ...
                <a 
                  href="https://www.instagram.com/driftlessgaragedoors?igsh=MTk2ZzltbnNobzFhNA==" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="inline-block text-gray-400 hover:text-red-500 transition-colors duration-200"
